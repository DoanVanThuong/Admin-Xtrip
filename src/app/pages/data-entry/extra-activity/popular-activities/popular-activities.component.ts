...
import { ProductDestination, Product, ProductRepo, Spinner, NotificationService, Error, JsonResult } from '../../../../common';
import { TYPE } from '../extra-activity.component';

@Component({
    selector: 'popular-activities',
    templateUrl: './popular-activities.component.html',
    styleUrls: ['./popular-activities.component.less']
})
export class PopularActivityComponent extends AppList {
